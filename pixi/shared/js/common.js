...
aidn.init = {
    ...
    selectBasePath: function(e, t) {
        var n = parseInt(aidn.util.getCookie("baseid"))
          , i = e;
        return (isNaN(n) || 1 == t) && (n = Math.floor(Math.random() * i.length),
...
aidn.ref = {
    ...
    __update: function() {
        for (var e, t = aidn.ref.__list, n = aidn.ref.__total, i = aidn.ref.__interval, a = 0; a < n; a++)
            (e = t[a]).time += i,
...
aidn.util = {
    ...
    getiOSVersion: function() {
        ...
        return t && t[1] ? parseFloat(t[1].replace("_", ".")) : (t = e.match(/iPad; CPU OS (\d+_*\d*)/)) && t[1] ? parseFloat(t[1].replace("_", ".")) : aidn.util.checkiOS() && (t = e.match(/Version\/(\d+\.*\d*)/)) && t[1] ? t[1] : -1
    },
    ...
    getCookie: function(e) {
        ...
        if (0 <= a) {
            var o = a + n.length
              , r = i.indexOf(";", o);
            -1 == r && (r = i.length),
            t = decodeURIComponent(i.substring(o, r))
        }
        return t
    },
    ...
    needExpandArea: function(e) {
        var t = navigator.userAgent
          , n = 0 <= t.indexOf("iPhone") || 0 <= t.indexOf("iPod");
        return (n = n && 0 <= t.indexOf("Version/") && Math.max(window.screen.width, window.screen.height) < 600) && 1 == e && (window.scrollTo(0, 0),
...
aidn.adv = {
    show: function(e, t) {
        if (aidn.adv._useAdv() && 1 != aidn.adv._e)
            if (aidn.adv._e)
                aidn.adv._e.show();
            else {
                var n = void 0 === t;
                0 <= e || (e = 0,
                window.innerHeight <= 570 && (e = 1));
                var i = "";
                aidn.util.getQuery().lc && (i = " background:rgba(64, 64, 64, 0.6);");
                var a = "width: 320px;" + i;
                switch (e) {
                case 0:
                    a += " height: 100px;";
                ...
                var o = "";
                n && (o = "position: absolute; bottom: 0; z-index: 100000; left: 50%; transform: translateX(-50%); ");
                var r = "";
                switch (r += '<div style="' + o + 'width: 320px;"><div id="close_adv" style="text-align: right; cursor:pointer;">',
                r += '<svg style="vertical-align:bottom; background:rgba(255, 255, 255, 0.6);" width="12" height="12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd"><path d="M12 11.293l10.293-10.293.707.707-10.293 10.293 10.293 10.293-.707.707-10.293-10.293-10.293 10.293-.707-.707 10.293-10.293-10.293-10.293.707-.707 10.293 10.293z"/></svg>',
                r += "</div>",
                r += '<div style="' + a + '">',
                r += '<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"><\/script>',
                e) {
                case 0:
                    r += '<ins class="adsbygoogle" style="display:inline-block;width:320px;height:100px" data-ad-client="ca-pub-2758302531676411" data-ad-slot="8440261214"></ins>';
                    break;
                default:
                    r += '<ins class="adsbygoogle" style="display:inline-block;width:320px;height:50px" data-ad-client="ca-pub-2758302531676411" data-ad-slot="1050207427"></ins>'
                }
                r += "<script>(adsbygoogle = window.adsbygoogle || []).push({});<\/script>",
                r += "</div>",
                r += "</div>",
                (aidn.adv._e = $(r)).children("#close_adv").on("click", aidn.adv.close),
                n ? $("body").append(aidn.adv._e) : t.append(aidn.adv._e)
            }
    },
    hide: function() {
...
aidn.social = {
    ...
    shareFb: function(e, t) {
        var n = "https://www.facebook.com/sharer/sharer.php?u=" + encodeURIComponent(e);
    ...
    shareHatena: function(e, t) {
        ...
        t ? aidn.util.checkMobile() ? window.open(n) : window.open(n, "hatena", "width=1024, height=790, personalbar=0,toolbar=0,scrollbars=1,resizable=1") : location.href = n
    },
...
function __checkInit() {
    if ("undefined" == typeof jQuery)
        setTimeout(__checkInit, 10);
    else {
        var e = window.__s;
        e && "string" == typeof e && ($.ajax({
            url: e,
            cache: !0,
            dataType: "script"
        }),
        ...
        $(function() {
            ...
            if (8 <= e && aidn.util.checkStandAlone()) {
                ...
                document.addEventListener("visibilitychange", function(e) {
                    "visible" == document.visibilityState && location.href != localStorage.getItem(t) && (location.href = localStorage.getItem(t))
                })
            }
            var n = navigator.userAgent;
            if ((0 < n.indexOf("MSIE") || 0 < n.indexOf("rv:11.0")) && 0 < $("svg").length) {
                function i() {
                    $("svg").each(function() {
                        var e = $(this);
            ...
            if (12.2 <= e) {
                for (var o = ["/mikuboard", "/vtofu", "/omikuji", "/momoko_vr", "/catsphere", "/shake", "/m/nijimi"], r = location.href, d = !1, s = 0, l = 0; l < o.length; l++)
                    0 < r.indexOf(o[l]) && (d = !0,
                    s = o[l].split("/").length - 2);
                if (1 == $("body").data("motion")) {
                    var c = location.href.split("aidn");
                    2 <= c.length && (d = !0,
                    s = c[1].split("/").length - 3)
                }
                if (d) {
            ...
            if (_isJapanese || null != document.getElementById("google_translate_element") && $.getScript("//translate.google.com/translate_a/element.js?cb=__googleTranslateElementInit", function() {
                var e = $(".aidnsub").length
                  , t = aidn.util.getQuery();
                setInterval(function() {
                    $(".goog-te-banner-frame").length && ("none" == $(".skiptranslate").css("display") ? e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 0) : $("#menu").css("top", 0)) : (e && ("block" == $("#bt_menu").css("display") ? $("#menu, #bt_menu").css("top", 39) : $("#menu").css("top", 39)),
                    $(window).width() < 480 ? $("iframe:first").contents().find(".goog-te-button").css("display", "none") : $("iframe:first").contents().find(".goog-te-button").css("display", "block"),
            ...
            if (0 < $("#aidn").length && (_active = !1),
            0 < $("#aidnx").length && (_active = !1,
            $("#bt_menu").on("click", function() {
                $("#menu").stop().slideToggle(150)
            })),
            !_active) {
                var f = aidn.constant.advUrlEn;
                aidn.util.checkJapanese() && (f = aidn.constant.advUrlJa);
                var v = "";
                if (v += '<a href="' + f + '" target="_blank"><div class="adv_con">',
                v += '<p class="text">' + aidn.constant.advTex + "</p>",
                v += '<p class="image"><img src="' + aidn.constant.advImg + '" alt="' + aidn.constant.advAlt + '" /></p>',
                v += "</div></a>",
                0 < $("#adsen").length && aidn.adv.show(0, $("#adsen")),
                0 < $(".adv").length)
                    $(".adv").html(v),
                    ...
                    var g = $("#common_back");
                    0 < g.length && (v = '<div class="adv"><div class="hr_top"></div>' + v + "</div>",
                    $("body").css("overflow", "auto"),
                    g.after(v))
                }
            }
...
aidn.Audio = function() {
    aidn.audio.init();
    var o, r, d, s, l, t, c = this, u = new Audio, n = 1;
    ...
    this.play = function(t, e, n, i, a) {
        ...
        u.play(),
        0 < i && "undefined" != typeof jQuery ? (c.volume = 0,
        $(c).stop().animate({
            volume: a
        }, 1e3 * i, "easeInSine")) : c.volume = a
    }
    ,
    this.pause = function() {
        u.pause()
...
aidn.WebAudio = function() {
    aidn.audio.init();
    var f, v, u, h, g, m, p, w, b, _, y, x, t, E = this, k = [], O = 0, A = 100, S = -1, F = !1, n = 1, I = 1;
    if (void 0 !== aidn.___waContext)
        this._context = f = aidn.___waContext;
    else {
        try {
    ...
    this.load = function(e, u, t, n) {
        ...
        function c() {
            ...
            f.decodeAudioData(e, function(e) {
                if (0 <= S) {
                    for (var t = S, n = Number.MAX_VALUE, i = e.numberOfChannels, a = 0; a < i; a++) {
    ...
    this.play = function(e, t, n, i, a, o) {
        ...
        void 0 === a ? a = I : I = a,
        void 0 === o && (o = 0),
        (u = f.createBufferSource()).buffer = v,
        u.loop = t,
        u.onended = T,
        g || (g = f.createGain());
        var r = [u, g];
        ...
        for (var d = 1; d < r.length; d++) {
            var s = r[d - 1]
              , l = r[d];
            s.connect(l),
            d == r.length - 1 && l.connect(f.destination)
        }
        if (u.start ? u.start(f.currentTime + o, e) : u.noteOn(e),
        O = f.currentTime - e,
        this._source = u,
        this.nodeGain = g,
        0 < i && "undefined" != typeof jQuery ? (E.volume = 0,
        $(E).stop().animate({
            volume: a
        }, 1e3 * i, "easeInSine")) : E.volume = a,
        n)
            var c = setInterval(function() {
                0 < E.time && (clearInterval(c),
                n())
            }, 10)
    }
    ,
...
aidn.AutoAudio = function(e, t, n) {
    ...
    aidn.audio.init();
    var i, a, o, r = 2;
    if ("undefined" != typeof swfobject && swfobject.hasFlashPlayerVersion(10) && null != e ? r = 0 : aidn.util.webaudio && (r = 1),
    0 <= n && n <= 2 && (r = n),
    ...
    0 == r) {
        ...
        var l = setInterval(function() {
            document.getElementById("flash_audio").loadFunc && (clearInterval(l),
