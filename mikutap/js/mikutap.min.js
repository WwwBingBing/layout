        ...
        (this.init = function (t, o) {
          ...
          (this.update = function () {
            if (t) {
              ...
              if (
                v * p < a &&
                ((v = Math.floor(a / p) + 1), 0 <= (a = v * p - a) && X)
              )
        ...
        function r(a, e, n) {
          v != a &&
            ...
            0 > v ||
              ...
              0 >= --F &&
                ((e = Math.floor(k.length * Math.random())),
                (n = e + P.length),
            ...
            this.play = function (a, f) {
              ...
              for (var p = 360 / s, m = 0; m < s; m++) {
                var y = (m * p * Math.PI) / 180,
                  I = u * Math.cos(y),
                  x =
                    ((y = u * Math.sin(y)), I + u * (Math.random() - 0.5) * v),
                  b = y + u * (Math.random() - 0.5) * v;
                (c["p" + m] = { x: I, y: y }),
                  TweenLite.to(c["p" + m], 0.6, { x: x, y: b });
              }
              (c.progress = 0),
                TweenLite.to(c, 0.8, {
                  progress: 1,
          ...
          f = function (a, e) {
            ...
            this.play = function (a) {
              (r = a),
                ...
                (s.x = w / 2),
                (s.y = M / 2),
                (s.rotation = 0.5 * Math.PI * Math.floor(4 * Math.random())),
                (a = Math.floor(7 * Math.random() + 2));
              var e = 0.8 * Math.min(w, M);
              i.size = e;
              for (
                var h,
                  c = (e / a) * (0.4 * Math.random() + 0.7),
                  f = (e / a) * (0.4 * Math.random() + 0.1),
                  u = l(),
                  v = 0,
                  p = 0;
                p <= a;
                ...
                var m = { x: -e / 2, y: (h = (p - 0.5 * a) * c) },
                  y = { x: e / 2, y: h };
                v < (m = (h = d[p] ? d[p] : new t(s)).play(m, y, f, u)) &&
                  (v = m),
                  (d[p] = h);
              }
              ...
              (z = new (function (a) {
                ...
                (this.resize = function () {
                  ...
                  (this.flash = function () {
                    ...
                    for (var a = 0; 3 > a; a += 2)
                      TweenLite.delayedCall(0.07 * a, e),
                        TweenLite.delayedCall(0.07 * (a + 1), n);
                  }),
          ...
          P = [
            ...
            function (a, e) {
              ...
              this.play = function () {
                ...
                for (
                  var a = 10,
                    e = l(),
                    i = (Math.min(w, M) / 64) * (0.6 * Math.random() + 0.7),
                    d = 2,
                    h = 0;
                  40 > h;
                  h++
            ...
            function (a, e) {
              ...
              this.play = function () {
                ...
                for (
                  var a = Math.floor(5 * Math.random() + 5), e = 0;
                  e < a;
                  e++
                ) {
                  var i;
            ...
            function (a, e) {
              ...
              this.play = function () {
                ...
                var e =
                    ...
                    ((45 * Math.PI) / 180) * Math.floor(4 * Math.random() - 2),
                  t = 0.3 * Math.random() + 1,
                  s = 0.3 * -Math.random() + 1;
                TweenLite.fromTo(
                  l.container,
                  ...
                  TweenLite.fromTo(
                    ...
                    0.6,
                    { x: t, y: t },
                    { x: s, y: s, ease: Back.easeOut.config(1.7) }
                  ),
                  TweenLite.fromTo(
                    r.scale,
                    0.6,
            ...
            function (a, e) {
              ...
              this.play = function () {
                i.setChildIndex(o, i.children.length - 1),
                  ...
                  (o.y = M / 2);
                for (
                  var a = 0.6 * Math.min(w, M),
                    e = Math.floor(5 * Math.random()) + 3,
                    t = 360 / e,
                    r = ((0.5 * Math.max(w, M)) / a) * (1.6 + 0.6 / e),
                    s = 0;
                  s <= e;
                  s++
                ) {
                ...
                (a = 0.3 * Math.random() + 0.6),
                  TweenLite.fromTo(
                    ...
                    a,
                    { x: 0, y: 0 },
                    { x: r, y: r, onComplete: n, ease: Power2.easeOut }
                  ),
                  TweenLite.fromTo(
                    o,
                    a,
                ...
                (this.init = function (a, e, n, t) {
                  ...
                  (this.play = function (a, n) {
                    ...
                    TweenLite.fromTo(
                      ...
                      1,
                      { rotation: 0 },
                      { rotation: s, ease: Bounce.easeOut, delay: a }
                    );
                  });
                var t,
                  i = new PIXI.Graphics();
            ...
            function (a, e) {
              ...
              this.play = function () {
                (o.visible = !0),
                  i.setChildIndex(o, i.children.length - 1),
                  (o.x = 0.2 * w + 0.6 * w * Math.random()),
                  (o.y = 0.2 * M + 0.6 * M * Math.random());
                ...
                r.clear(),
                  ...
                  new TimelineLite()
                    ...
                    .to(
                      o,
                      0.6,
                      { rotation: a, ease: Back.easeOut.config(1.7) },
                      0
                    )
                    ...
                    .to(
                      s.scale,
                      0.3,
                      { y: 0, ease: Power2.easeOut, onComplete: n },
                      0.6
                    );
              };
              var t = this,
            ...
            function (a, e) {
              ...
              function t() {
                switch ((f.clear(), f.lineStyle(r, s, 1), o)) {
                  case 0:
                    ...
                    break;
                  case 1:
                    for (f.moveTo(c.x, c.y), a = h; a <= i; a++)
              ...
              (this.play = function () {
                f.clear(),
                  (f.visible = !0),
                  0.5 > Math.random()
                    ? ((f.x = 0), (f.y = 0), (f.rotation = 0))
                    : ((f.x = w), (f.y = M), (f.rotation = Math.PI)),
                  (h = o = 0),
                ...
                for (var t = 0; t <= i; t++) {
                  var u;
                  e
                    ? ((u = { x: t * a, y: M * Math.random() }),
                      0 == t && (u.x -= 10),
                      t == i && (u.x += 10))
                    : ((u = { y: t * a, x: w * Math.random() }),
                      0 == t && (u.y -= 10),
                      t == i && (u.y += 10)),
                    (d[t] = u);
                }
              ...
              this.play = function () {
                ...
                a
                  ...
                  : ((f = w / e),
                    ...
                    (i.pos.b1 = { x: w, y: 0 })),
                  0.5 > Math.random()
                    ? ((h.rotation = 0), (h.x = 0), (h.y = 0))
                    : ((h.rotation = Math.PI), (h.x = w), (h.y = M));
                for (var u = (l = 0); u <= e; u++) {
                  var v = { x: 0, y: 0 },
                    p = 0;
    ...
    i(),
      aidn.util.webaudio
        ? ($("#ng").css("display", "none"),
          ...
          u || $("#scene_top .attention").text("* 把声音开大点，然后享受吧！"))
